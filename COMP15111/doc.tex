...
%TODO: Make the stack pointer start at the top and descend on pops
%TODO: Work out if the stack pointer points to the next address or the current one
%TODO: Add stuff about using post and pre indexing with STR and LDR instead of POP and PUSH
...
%TODO: Check that the DEFS command is *actually* used. In ARM assembly, a stack
...
\begin{drawstack}
	...
	\cell{0}	\cellptr{{\tt 0x00000400} (SP)}
\end{drawstack}
\end{center}
...
\begin{drawstack}
	...
	\cell{0}	\cellptr{{\tt 0x00000412}}
	\cell{0}	\cellptr{{\tt 0x00000408}}
	\cell{0}	\cellptr{{\tt 0x00000404} (SP)}
	\cell{20}	\cellptr{{\tt 0x00000400}}
\end{drawstack}
\end{center}
...
\begin{drawstack}
	\cell{0}	\cellptr{{\tt 0x00000416}}
	\cell{0}	\cellptr{{\tt 0x00000412} (SP)}
	\cell{8}	\cellptr{{\tt 0x00000408}}
	\cell{523}	\cellptr{{\tt 0x00000404}}
	\cell{20}	\cellptr{{\tt 0x00000400}}
\end{drawstack}
\end{center}
