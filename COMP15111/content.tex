...
\marginpar{\raggedright SWI is another name for SVC - they do the same thing.}
...
\marginpar{\raggedright Note that {\tt MUL} cannot use literals. To get around
this, first {\tt MOV} the literal into a register and then multiply.}
...
\marginpar{\vspace{-6em}Here, we use {\tt R1} to store the message, {\tt R0} to
...
\marginpar{\vspace{-10em}Note how this snippet has an optimisation to use one
less register during the looping process than the string length snippet does. It
