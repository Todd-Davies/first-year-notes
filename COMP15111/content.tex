...
itself. The parameter of an {\tt SVC} call defines its exact
operation.
...
TST performs a bitwise {\tt AND} on its operands (a register and a literal test
...
of running code from its environment. For example, code running inside a
...
information about the object such as its size, storage for the instance
