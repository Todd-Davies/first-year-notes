...
\card{
	How many outcomes does the Bernoulli distribution have, what's it's range and it's pmf?
}{
	The Bernoulli distribution has two outcomes. It's range is $R = \{0, 1\}$ and it's pmf is given by $p_x(1)=p, p_x(0)=1-p$.
}
...
\card{
	What is the range of the binomial distribution? What is it's pmf?
}{
